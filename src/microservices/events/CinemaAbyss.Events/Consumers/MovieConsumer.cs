...
public class MovieConsumer(ILogger<MovieConsumer> logger) : IConsumer<MovieEvent>
{
    private readonly ILogger<MovieConsumer> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
